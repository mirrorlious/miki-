        ...
        <div className="mx-auto max-w-6xl px-5 py-3 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 text-xs text-gray-500">
            ...
            {cloud.enabled && !cloud.user && (
              <button type="button" onClick={cloud.onSignIn} className="h-8 px-3 rounded-lg bg-white text-xs font-bold text-gray-700 shadow-sm hover:bg-gray-50 flex items-center gap-1.5">
                <LogIn size={13} /> 登录
              </button>
            )}
            {cloud.enabled && cloud.user && (
